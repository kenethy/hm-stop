#!/bin/bash
# update-app-with-labor-cost-fix-v2.sh - Script untuk memperbarui aplikasi dengan perbaikan biaya jasa montir (versi 2)
...
echo -e "${YELLOW}Memulai pembaruan aplikasi dengan perbaikan biaya jasa montir (versi 2)...${NC}\n"
...
echo -e "\n${GREEN}Pembaruan aplikasi dengan perbaikan biaya jasa montir (versi 2) selesai!${NC}"
echo -e "${YELLOW}Catatan:${NC}"
echo -e "1. Perbaikan yang telah dilakukan:"
echo -e "   - Memperbaiki kondisi default labor cost di ServiceResource.php"
echo -e "   - Memperbaiki kondisi default labor cost di EditService.php"
echo -e "   - Menambahkan log untuk memantau nilai biaya jasa montir"
...
echo -e "3. Periksa log untuk memastikan tidak ada error: docker-compose exec app cat storage/logs/laravel.log | grep -i \"labor_cost\" | tail -n 100"
