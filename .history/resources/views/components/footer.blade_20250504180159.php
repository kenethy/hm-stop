        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <!-- Social Media Icons -->
                    <a href="https://instagram.com/hartonomotor" target="_blank" aria-label="Instagram Hartono Motor"
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="https://www.lazada.co.id/tag/hartono-motor-sidoarjo/" target="_blank"
