    ...
    <div class="container mx-auto px-4">
        ...
        <div class="relative overflow-hidden rounded-lg mb-12">
            ...
            <div class="relative z-10 py-16 px-8 md:py-24 md:px-12">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="#limited-slots" class="bg-white text-red-600 hover:bg-gray-200 font-bold py-3 px-6 rounded-full inline-flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd" />
                        </svg>
                        Slot Terbatas
                    </a>
                    <a href="#ending-soon" class="bg-red-600 text-white hover:bg-red-700 font-bold py-3 px-6 rounded-full inline-flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd" />
                        </svg>
                        Segera Berakhir
        ...
        <div class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-900 rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105">
                    <div class="relative">
                        @if($promo->image_path)
                        ...
                        <div class="absolute bottom-0 left-0 bg-yellow-500 text-black px-3 py-1 m-2 rounded-full text-sm font-bold animate-pulse">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div>
                                ...
                                <span class="text-white font-bold text-xl block">Rp {{ number_format($promo->promo_price, 0, ',', '.') }}</span>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="w-full bg-gray-700 rounded-full h-2">
                                <div class="bg-red-600 h-2 rounded-full" style="width: {{ min(100, max(10, ($promo->remaining_slots / 20) * 100)) }}%"></div>
                            </div>
                        </div>
                        @endif
                        
                        <a href="{{ route('promos.show', $promo->id) }}" class="block w-full bg-red-600 hover:bg-red-700 text-white text-center font-bold py-2 px-4 rounded-full transition duration-300">
                            LIHAT DETAIL
                        </a>
                    </div>
                </div>
        ...
        <div id="ending-soon" class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-900 rounded-lg overflow-hidden shadow-lg border border-yellow-500">
                    <div class="relative">
                        @if($promo->image_path)
                            <img src="{{ asset('storage/' . $promo->image_path) }}" alt="{{ $promo->title }}" class="w-full h-40 object-cover">
                        @else
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mb-3">
                            <div>
                                <span class="text-gray-500 line-through text-sm">Rp {{ number_format($promo->original_price, 0, ',', '.') }}</span>
                                <span class="text-white font-bold block">Rp {{ number_format($promo->promo_price, 0, ',', '.') }}</span>
                            </div>
                        ...
                        <a href="{{ route('promos.show', $promo->id) }}" class="block w-full bg-yellow-500 hover:bg-yellow-600 text-black text-center font-bold py-2 px-4 rounded-full transition duration-300 text-sm">
                            AMBIL SEKARANG
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-gray-900 rounded-lg overflow-hidden shadow-lg border border-white">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="w-full bg-gray-700 rounded-full h-2">
                                <div class="bg-white h-2 rounded-full" style="width: {{ min(100, max(10, ($promo->remaining_slots / 20) * 100)) }}%"></div>
                            </div>
                        </div>
                        
                        <a href="{{ route('promos.show', $promo->id) }}" class="block w-full bg-white hover:bg-gray-200 text-red-600 text-center font-bold py-2 px-4 rounded-full transition duration-300 text-sm">
                            BOOKING SEKARANG
                        </a>
                    </div>
                </div>
