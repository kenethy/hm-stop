...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <div class="mt-4">
                <a href="{{ route('promos') }}"
                    class="inline-flex items-center text-red-600 font-bold hover:text-red-700 transition-colors">
                    LIHAT SEMUA PROMO
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div
                class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all transform hover:-translate-y-1">
                <div class="relative">
                    @if($promo->image_path)
                    <img src="{{ asset('storage/' . $promo->image_path) }}" alt="{{ $promo->title }}"
                        class="w-full h-48 object-cover">
                    @else
                    <img src="{{ asset('images/promo-default.jpg') }}" alt="{{ $promo->title }}"
                        class="w-full h-48 object-cover">
                    @endif
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        <span class="text-gray-500 line-through">Rp {{ number_format($promo->original_price, 0, ',',
                            '.') }}</span>
                        <span class="text-red-600 font-bold text-xl block">Rp {{ number_format($promo->promo_price, 0,
                            ',', '.') }}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('promos.show', $promo->id) }}"
                            class="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-full transition-colors">
                            Lihat Detail
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-black text-white rounded-lg p-6 md:p-8">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                ...
                <a href="{{ route('promos') }}#ending-soon"
                    class="mt-4 md:mt-0 inline-flex items-center bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full transition-colors">
                    LIHAT SEMUA
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
                ...
                <div class="bg-gray-900 rounded-lg overflow-hidden flex flex-col md:flex-row">
                    <div class="md:w-1/3 relative">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-2">
                            <div
                                class="bg-yellow-500 text-black px-2 py-1 rounded-full text-xs font-bold inline-block animate-pulse">
                    ...
                    <div class="md:w-2/3 p-4">
                        ...
                        <div class="flex items-center gap-2 mb-2">
                            <span class="text-gray-400 line-through text-sm">Rp {{ number_format($promo->original_price,
                                0, ',', '.') }}</span>
                        ...
                        <a href="{{ route('promos.show', $promo->id) }}"
                            class="inline-block bg-yellow-500 hover:bg-yellow-600 text-black text-center font-bold py-1 px-4 rounded-full transition-colors text-sm">
                            AMBIL SEKARANG
                        </a>
                    </div>
                </div>
...
<section class="py-16 bg-gray-100">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Apa kata pelanggan tentang layanan kami.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="flex items-center mb-4">
                    <img src="{{ asset('images/testimonial-1.jpg') }}" alt="Customer"
                        class="w-12 h-12 rounded-full object-cover mr-4">
                    <div>
                        <h4 class="font-bold">Budi Santoso</h4>
                        <p class="text-gray-600 text-sm">Pelanggan Tetap</p>
                    </div>
                </div>
                <div class="mb-4">
                ...
                <p class="text-gray-600">"Sudah lebih dari 5 tahun saya selalu servis mobil di Hartono Motor.
                    Pelayanannya cepat, mekaniknya profesional, dan hasil servisnya selalu memuaskan. Recommended!"</p>
            </div>

            <!-- Testimonial 2 -->
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="flex items-center mb-4">
                    <img src="{{ asset('images/testimonial-2.jpg') }}" alt="Customer"
                        class="w-12 h-12 rounded-full object-cover mr-4">
                    <div>
                ...
                <p class="text-gray-600">"Pertama kali servis di sini dan sangat puas dengan hasilnya. AC mobil saya
                    yang tadinya tidak dingin sekarang sudah normal kembali. Harga juga terjangkau dan transparan."</p>
            </div>

            <!-- Testimonial 3 -->
            <div class="bg-white p-6 rounded-lg shadow-md">
                <div class="flex items-center mb-4">
                    <img src="{{ asset('images/testimonial-3.jpg') }}" alt="Customer"
                        class="w-12 h-12 rounded-full object-cover mr-4">
                    <div>
                ...
                <p class="text-gray-600">"Yang saya suka dari Hartono Motor adalah ketersediaan sparepart yang lengkap.
                    Tidak perlu menunggu lama untuk penggantian komponen. Mekaniknya juga ramah dan informatif."</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-6">
            ...
            <a href="https://www.tokopedia.com/hartonomotor" target="_blank"
                ...
                <img src="{{ asset('images/tokopedia.png') }}" alt="Tokopedia" class="h-16 w-16 object-contain mb-3">
                <span class="font-medium text-gray-900">Tokopedia</span>
            </a>

            <a href="https://shopee.co.id/hartonomotor" target="_blank"
                class="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <img src="{{ asset('images/shopee.png') }}" alt="Shopee" class="h-16 w-16 object-contain mb-3">
                <span class="font-medium text-gray-900">Shopee</span>
            </a>

            <a href="https://www.lazada.co.id/shop/hartonomotor" target="_blank"
                class="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <img src="{{ asset('images/lazada.png') }}" alt="Lazada" class="h-16 w-16 object-contain mb-3">
            ...
            <a href="https://instagram.com/hartonomotor" target="_blank"
                class="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <img src="{{ asset('images/instagram.png') }}" alt="Instagram" class="h-16 w-16 object-contain mb-3">
                <span class="font-medium text-gray-900">Instagram</span>
            </a>

            <a href="https://facebook.com/hartonomotor" target="_blank"
                class="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <img src="{{ asset('images/facebook.png') }}" alt="Facebook" class="h-16 w-16 object-contain mb-3">
                <span class="font-medium text-gray-900">Facebook</span>
            </a>

            <a href="https://tiktok.com/@hartonomotor" target="_blank"
                class="flex flex-col items-center p-4 rounded-lg hover:bg-gray-50 transition-colors">
                <img src="{{ asset('images/tiktok.png') }}" alt="TikTok" class="h-16 w-16 object-contain mb-3">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="rounded-lg overflow-hidden shadow-md h-96">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15830.953886801071!2d112.7167!3d-7.4458!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e6dd7fa4ee2f%3A0x4027a76e3c73a30!2sSidoarjo%2C%20Jawa%20Timur!5e0!3m2!1sid!2sid!4v1653372615261!5m2!1sid!2sid"
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Jl. Raya Sidoarjo No. 123, Sidoarjo, Jawa Timur</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">(031) 8912345</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">info@hartonomotor.com</p>
                        </div>
                    </div>
