...
<section class="relative bg-gray-900 text-white">
    <div class="absolute inset-0 overflow-hidden">
        <img src="{{ asset('C:\Users\jonat\Documents\augment-projects\hartono motor\hartono-motor\public\images') }}"
            alt="Hartono Motor Workshop" class="w-full h-full object-cover opacity-40">
    </div>
