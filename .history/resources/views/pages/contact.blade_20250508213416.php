...
<section class="relative bg-gray-900 text-white py-20">
    <div class="absolute inset-0 overflow-hidden">
        <img style="object-position: center 80%;" src="{{ asset('images/kontak/kontak.png') }}"
...
<script>
    function sendToWhatsApp(event) {
        ...
        const formattedMessage =
            `*Pesan dari Website Hartono Motor*%0A%0A` +
            `*Nama:* ${name}%0A` +
            `*Telepon:* ${phone}%0A` +
            `*Subjek:* ${subject}%0A%0A` +
            `*Pesan:*%0A${message}`;

        // WhatsApp number (62 821 3520 2581)
        const whatsappNumber = '6282135202581';
        ...
        successDiv.innerHTML = `
            <strong class="font-bold">Berhasil!</strong>
            <span class="block sm:inline">Pesan Anda telah diarahkan ke WhatsApp. Silakan lanjutkan di aplikasi WhatsApp.</span>
        `;
