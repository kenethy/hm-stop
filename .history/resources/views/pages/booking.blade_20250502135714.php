...
<section class="relative bg-gray-900 text-white py-20">
    <div class="absolute inset-0 overflow-hidden">
        <img src="{{ asset('images/booking-bg.jpg') }}" alt="Booking Servis Hartono Motor"
            class="w-full h-full object-cover opacity-40">
    </div>
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-3xl">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Booking Servis Online</h1>
            <p class="text-xl">Buat janji servis secara online untuk pengalaman servis yang lebih nyaman dan efisien.
            </p>
        </div>
    </div>
</section>
