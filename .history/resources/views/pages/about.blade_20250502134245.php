        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-gray-600 mb-4">Hartono Motor didirikan pada tahun 2005 oleh Bapak Hartono, seorang mekanik berpengalaman dengan passion di bidang otomotif. Berawal dari bengkel kecil di garasi rumah, Hartono Motor terus berkembang hingga menjadi bengkel terpercaya di Sidoarjo.</p>
                ...
                <div>
                    <img src="{{ asset('images/about-1.jpg') }}" alt="Sejarah Hartono Motor" class="rounded-lg shadow-md w-full">
                </div>
            </div>
        </div>
    </section>
