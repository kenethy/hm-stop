...
<section class="relative bg-gray-900 text-white py-20">
    <div class="absolute inset-0 overflow-hidden">
        <img src="{{ asset('images/blog-bg.jpg') }}" alt="Blog Hartono Motor"
...
<section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
                class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow hover-lift reveal-up">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold mb-2">
                        <a href="{{ route('blog.show', $post->slug) }}"
                            class="text-gray-900 hover:text-red-600 transition-colors">{{ $post->title }}</a>
                    </h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-700">
                                Menampilkan artikel dalam kategori: <span class="font-semibold">{{
                                    $categories->where('slug', $activeCategory)->first()->name }}</span>
                            </p>
                            @elseif($activeTag)
                            <p class="text-gray-700">
                                Menampilkan artikel dengan tag: <span class="font-semibold">{{
                                    $popularTags->where('slug', $activeTag)->first()->name }}</span>
                            </p>
                            @elseif($search)
                            <p class="text-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <!-- Blog Post -->
                    <div
                        class="bg-gray-50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow reveal-up">
                        <a href="{{ route('blog.show', $post->slug) }}">
                            <img src="{{ asset('storage/' . $post->featured_image) }}" alt="{{ $post->title }}"
            ...
            <div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 shadow-md mb-8 reveal">
                    ...
                    <form action="{{ route('blog.index') }}" method="GET">
                        <div class="flex">
                            <input type="text" name="search" value="{{ $search }}" placeholder="Kata kunci..."
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="{{ route('blog.category', $category->slug) }}"
                                class="flex items-center text-gray-700 hover:text-red-600 transition-colors {{ $activeCategory === $category->slug ? 'text-red-600 font-medium' : '' }}">
                ...
                <div class="bg-gray-50 rounded-lg p-6 shadow-md mb-8 reveal">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('blog.tag', $tag->slug) }}"
                            class="inline-block px-3 py-1 bg-gray-200 text-gray-800 rounded-full text-sm hover:bg-red-100 hover:text-red-600 transition-colors {{ $activeTag === $tag->slug ? 'bg-red-100 text-red-600 font-medium' : '' }}">
                            #{{ $tag->name }}
                        </a>
                        @endforeach
                    </div>
    ...
    <div class="container mx-auto px-4">
        <div class="bg-white rounded-lg shadow-md p-8 md:p-12 reveal">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <p class="text-gray-600 mb-8">Tim mekanik profesional kami siap membantu menjawab pertanyaan Anda
                    seputar perawatan dan perbaikan mobil. Hubungi kami atau booking servis sekarang.</p>
