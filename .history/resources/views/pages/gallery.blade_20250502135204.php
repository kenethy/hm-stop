...
@section('content')
    ...
    <section class="relative bg-gray-900 text-white py-20">
        <div class="absolute inset-0 overflow-hidden">
            <img src="{{ asset('images/gallery-bg.jpg') }}" alt="Galeri Hartono Motor" class="w-full h-full object-cover opacity-40">
        </div>
    ...
    <section class="py-8 bg-white">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-center gap-4">
                <button class="bg-red-600 text-white px-4 py-2 rounded-md font-medium">Semua</button>
                <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md font-medium transition-colors">Bengkel</button>
                <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md font-medium transition-colors">Hasil Servis</button>
                <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md font-medium transition-colors">Mekanik</button>
                <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-md font-medium transition-colors">Sparepart</button>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    <a href="{{ asset('images/gallery-1.jpg') }}" class="block relative group">
                        <img src="{{ asset('images/gallery-1.jpg') }}" alt="Tampak Depan Bengkel" class="w-full h-64 object-cover">
                ...
                <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    <a href="{{ asset('images/gallery-3.jpg') }}" class="block relative group">
                        <img src="{{ asset('images/gallery-3.jpg') }}" alt="Mekanik Bekerja" class="w-full h-64 object-cover">
                        <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                            <div class="text-white text-center p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                ...
                <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    <a href="{{ asset('images/gallery-4.jpg') }}" class="block relative group">
                        <img src="{{ asset('images/gallery-4.jpg') }}" alt="Hasil Servis Mesin" class="w-full h-64 object-cover">
                        <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                            <div class="text-white text-center p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                ...
                <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    <a href="{{ asset('images/gallery-7.jpg') }}" class="block relative group">
                        <img src="{{ asset('images/gallery-7.jpg') }}" alt="Hasil Servis AC" class="w-full h-64 object-cover">
                        <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                            <div class="text-white text-center p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                ...
                <div class="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-shadow">
                    <a href="{{ asset('images/gallery-9.jpg') }}" class="block relative group">
                        <img src="{{ asset('images/gallery-9.jpg') }}" alt="Koleksi Sparepart" class="w-full h-64 object-cover">
                        <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                            <div class="text-white text-center p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
            ...
            <div class="mt-10 text-center">
                <button class="bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-6 rounded-md transition-colors">Muat Lebih Banyak</button>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="bg-white rounded-lg shadow-md p-8 md:p-12">
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <p class="text-gray-600 mb-8">Kunjungi bengkel kami untuk melihat langsung fasilitas dan layanan yang kami sediakan. Atau booking servis sekarang untuk pengalaman servis yang memuaskan.</p>
