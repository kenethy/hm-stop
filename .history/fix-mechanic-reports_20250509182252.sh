...
echo "1. Tab untuk melihat servis berdasarkan status (Selesai, Dalam Pengerjaan, Dibatalkan)"
...
echo ""
echo "PENTING: Jika masih ada error, silakan jalankan script ini sekali lagi."
