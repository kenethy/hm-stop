...
# Copy manifest.json from host to container if it exists
if [ -f /var/www/html/public/build/manifest.json.host ]; then
    echo "Found manifest.json.host, copying to manifest.json..."
    cp /var/www/html/public/build/manifest.json.host /var/www/html/public/build/manifest.json
    chmod 777 /var/www/html/public/build/manifest.json
fi
