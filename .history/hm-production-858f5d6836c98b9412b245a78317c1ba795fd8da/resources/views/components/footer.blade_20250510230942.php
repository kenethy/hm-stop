        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    <!-- Social Media Icons -->
                    <a href="https://www.instagram.com/hartonomotorsidoarjo" target="_blank" aria-label="Instagram Hartono Motor"
                    ...
                    <a href="https://www.facebook.com/hartonomotorsidoarjo" target="_blank" aria-label="Facebook Hartono Motor"
                        class="text-white hover:text-red-500 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"
                            aria-hidden="true">
                            <path
