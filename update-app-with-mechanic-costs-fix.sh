#!/bin/bash
# update-app-with-mechanic-costs-fix.sh - Script untuk memperbarui aplikasi dengan perbaikan tampilan biaya jasa montir
...
echo -e "${YELLOW}Memulai pembaruan aplikasi dengan perbaikan tampilan biaya jasa montir...${NC}\n"
...
echo -e "\n${GREEN}Pembaruan aplikasi dengan perbaikan tampilan biaya jasa montir selesai!${NC}"
echo -e "${YELLOW}Catatan:${NC}"
echo -e "1. Perbaikan yang telah dilakukan:"
echo -e "   - Memperbaiki kondisi visibilitas komponen mechanic_costs agar langsung muncul jika sudah ada montir"
echo -e "   - Menambahkan pengecekan apakah record memiliki montir, tidak hanya bergantung pada form"
echo -e "2. Untuk menguji perbaikan:"
echo -e "   - Buka halaman edit servis untuk servis yang sudah memiliki montir"
